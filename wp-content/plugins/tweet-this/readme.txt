...
`Tweet This 1.8.1 is a bugfix release for Twitter "Snowflake" status IDs.
...
If you are upgrading from Tweet This 1.8 or older, follow these steps:
...
default. Optional tweet_text parameter overrides "Tweet Text" from the
